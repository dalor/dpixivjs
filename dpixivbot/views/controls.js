    ...
    markup.inlineKeyboard(
      [
        ...
        [
          ...
          markup.callbackButton(ctx.t("hide"), "hide", !data.show),
          markup.callbackButton("🔽", "show", data.show),
        ],
        [
          markup.callbackButton(
            ctx.t("preload"),
            "preload",
            !data.show || data.choosed || data.pageCount <= 1
          ),
          markup.callbackButton(
            ctx.t("full"),
            "full",
...
const similarMenu = (data, markup, ctx) => [
  ...
  [
    markup.callbackButton(
      ctx.t("with_description"),
      "withoutDescription",
      !data.description
    ),
    markup.callbackButton(
      ctx.t("without_description"),
      "withDescription",
      data.description
    ),
